    ...
    <div className="intro" id="intro">
      <div className="left">
          ...
          <p>A self-taught developer with an interest in Computer Science.</p>
            <button style={{ backgroundColor: "#0e0e0e", border: "none", color: "rgb(65, 201, 255)", margin: "3rem", padding: "8px", justifyContent: "center", alignItems: "center", alignContent: "center", display: "flex", gap: "5px", borderRadius: "7px", cursor: "pointer", fontWeight: 700 }}>View My CV. <IoMdOpen size={22} color="crimson"/></button>
